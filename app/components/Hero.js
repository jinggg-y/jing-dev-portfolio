    ...
    return (
        <div className="px-5 md:px-30 flex flex-col flex-grow">
            <div className="text-center p-7">
                ...
                <h3 className="text-2xl text-neutral-700 leading-7.5 font-semibold lg:text-3xl dark:text-red-200">IT Graduate.</h3>

                <p className="text-md pt-10 leading-7 max-w-2xl mx-auto lg:text-lg" data-aos="flip-up" data-aos-duration="1000">Detail-oriented IT Graduate with a strong foundation in software development, systems analysis, process improvement, and IT infrastructure support. <span className="hidden sm:inline">With hands-on experience in Agile and Waterfall methodologies, cloud adoption, data migration, and process optimisation, I excel in delivering high-quality, outcome-orientated solutions that drive efficiency, innovation, and business success.</span>
                </p>
